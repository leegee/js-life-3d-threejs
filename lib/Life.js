...
define([
    ...
    var Life = function  (options) {
        ...
        this.light = {
            ...
            z : -1 * this.screenHeight
        };
        light.position.set( this.light.x, this.light.y, this.light.z);
        ...
        this.camera.position.set(
            // 0,0, -1 * this.frustumFarPlane/10
            this.screenHeight/2,
            this.screenHeight/2,
            this.map? (-1 * this.map.length * this.screenHeight) : -4 * this.screenHeight
        );
